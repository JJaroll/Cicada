...
try:
    ...
    detect_checksum_type = get_firewire_id = None
try:
    ...
    resolve_device_path = DeviceWriteGuard = None
    inspect_device_write_readiness = revalidate_device_write_readiness = None
    volume_lock_key = None

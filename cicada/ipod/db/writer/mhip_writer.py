...
``cicada.ipod.db.shared.field_defs.MHIP_FIELDS``.
...
from cicada.ipod.db.shared.constants import MHOD_TYPE_TITLE
from cicada.ipod.db.shared.field_base import write_fields, write_generic_header
from cicada.ipod.db.shared.mhip_defs import MHIP_HEADER_SIZE
from cicada.ipod.db.shared.mhod_defs import (

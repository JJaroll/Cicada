...
MHBD_HEADER_SIZE: int = 244

MHBD_OFFSET_DB_ID: int = 0x18
MHBD_OFFSET_HASHING_SCHEME: int = 0x30
MHBD_OFFSET_UNK_0x32: int = 0x32
MHBD_OFFSET_HASH58: int = 0x58
MHBD_OFFSET_HASH72: int = 0x72
MHBD_OFFSET_HASHAB: int = 0xAB

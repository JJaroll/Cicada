...
Cicada is open-source software distributed under the **GNU GPLv3** license. It is provided "as is," without any warranty of any kind, either express or implied. The author (JJaroll) is not responsible for any errors, data loss, or damages resulting from the use of this software.
...
Cicada is an independently developed project. Technical support is not guaranteed, although collaboration through GitHub to report bugs or suggest improvements is highly encouraged.

## 7. Privacy and Data Collection
Cicada is designed as a **locally-run application**. We prioritize your privacy through the following principles:
* **No Data Collection**: Cicada does not collect, store, or transmit your personal data, music library information, or Spotify usage habits to any external server owned by the developer.
* **Local Storage**: All API keys, tokens, and configuration settings are stored exclusively on your local machine. No telemetry or usage tracking is implemented in the software.
* **Direct Communication**: Any data exchanged during the use of integrated services (such as Spotify or AcoustID) occurs strictly between your local client and those respective third-party service providers. The developer does not act as an intermediary or proxy for your data.

---
*For any questions or inquiries regarding these terms, please open an 'Issue' in the official JJaroll Cicada GitHub repository.*